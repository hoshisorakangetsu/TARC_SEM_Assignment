...
export const DiplomaCourses: DiplomaCourse[] = [
  ...
  },
  {
    ...
    progression: ["Bachelor of Software Engineering (Honours)"],
    career: [
    ...
    intake: [
      {
        year: "Year 1 Intake:",
        description:
          "February (KL); June (KL, PG, PK, JH, PH, SB); November (KL, PG, PK, PH)",
      },
      {
        year: "Year 2 Intake:",
